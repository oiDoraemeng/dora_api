...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.POST("/targeted-email/test", h.Admin.Setting.SendTargetedEmailTest)
		adminSettings.POST("/targeted-email/batch", h.Admin.Setting.SendTargetedEmailBatch)
