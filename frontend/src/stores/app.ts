...
import { DEFAULT_SITE_NAME, resolveDisplaySiteName } from '@/utils/brand'
...
export const useAppStore = defineStore('app', () => {
  ...
  function applySettings(config: PublicSettings): void {
    ...
    const displaySiteName = resolveDisplaySiteName(config.site_name)
    cachedPublicSettings.value = { ...config, site_name: displaySiteName }
    siteName.value = displaySiteName
