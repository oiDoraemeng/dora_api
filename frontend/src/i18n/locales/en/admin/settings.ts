export default {
    settings: {
      ...
      payment: {
        ...
        strategyPriorityFailoverHint: 'EasyPay instances use list order for primary/backup. QR code and popup modes are both supported; timeouts are not retried to prevent duplicate payments.',
        failoverPriority: 'EasyPay failover priority #{priority}',
        failoverPopupConflict: '{provider} supports {method} and is currently using popup mode.',
