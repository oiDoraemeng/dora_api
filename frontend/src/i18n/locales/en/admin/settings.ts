export default {
    settings: {
      ...
      payment: {
        ...
        strategyPriorityFailover: 'EasyPay Primary/Backup Failover',
        strategyPriorityFailoverHint: 'EasyPay instances use list order for primary/backup. Only QR code mode is supported; timeouts are not retried to prevent duplicate payments.',
        failoverPriority: 'EasyPay failover priority #{priority}',
        failoverPopupConflict: '{provider} supports {method} but uses popup mode. EasyPay primary/backup failover requires QR code mode.',
