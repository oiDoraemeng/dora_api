export default {
  ...
  imageGeneration: {
    ...
    apiKeySwitchHint: '切换 GPT 与 Gemini 生图模型时，请同步选择支持对应平台的 API Key。',
    modelLabel: '模型',
    modelPlaceholder: '选择生图模型',
    modelHint: '支持 GPT Image 与 Gemini Image 生图模型。',
    ...
    backendHint: '推荐使用 OpenAI Images API；温馨提示：图片可能不会长期保留，生成后请及时下载保存。',
    ...
    switchToGPTKeyToast: '已切换到 GPT 生图模型，请同步切换为 OpenAI 分组的 API Key。',
    promptLabel: '提示词',
  ...
  admin: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 Dora2API 用户登录',
      ...
      customMenu: {
        ...
        visibilityAdmin: '管理员',
        add: '添加菜单项',
        sidebarPosition: '我的账户菜单位置',
        sidebarPositionHint: '控制该自定义页面在“我的账户”菜单中的显示位置，保存设置后生效。',
        sidebarPositionAfterDashboard: '仪表盘后面',
        sidebarPositionAfterApiKeys: 'API 密钥后面',
        sidebarPositionAfterUsage: '用量统计后面',
        sidebarPositionAfterAvailableChannels: '可用渠道后面',
        sidebarPositionAfterImages: 'AI 生图后面',
        sidebarPositionAfterMonitor: '渠道状态后面',
        sidebarPositionAfterSubscriptions: '我的订阅后面',
        sidebarPositionAfterPurchase: '购买订阅后面',
        sidebarPositionAfterOrders: '我的订单后面',
        sidebarPositionAfterRedeem: '兑换后面',
        sidebarPositionAfterAffiliate: '邀请返利后面',
        sidebarPositionAfterProfile: '个人资料后面',
        sidebarPositionAfterCustom: '“{label}”后面',
        unnamedItem: '未命名菜单 #{n}',
        remove: '删除',
        moveUp: '上移',
        moveDown: '下移',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 Dora2API',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Dora2API 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 Dora2API 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 Dora2API',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 Dora2API AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
