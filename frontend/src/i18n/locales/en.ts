export default {
  ...
  // Setup Wizard
  setup: {
    title: 'Dora2API Setup',
    description: 'Configure your Dora2API instance',
    database: {
  ...
  admin: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for Dora2API end-user login',
      ...
      customMenu: {
        ...
        add: 'Add Menu Item',
        sidebarPosition: 'My Account Menu Position',
        sidebarPositionHint: 'Controls where this custom page appears in the My Account menu. Save settings to apply.',
        sidebarPositionAfterDashboard: 'After Dashboard',
        sidebarPositionAfterApiKeys: 'After API Keys',
        sidebarPositionAfterUsage: 'After Usage',
        sidebarPositionAfterAvailableChannels: 'After Available Channels',
        sidebarPositionAfterImages: 'After AI Images',
        sidebarPositionAfterMonitor: 'After Channel Status',
        sidebarPositionAfterSubscriptions: 'After My Subscriptions',
        sidebarPositionAfterPurchase: 'After Buy Subscription',
        sidebarPositionAfterOrders: 'After My Orders',
        sidebarPositionAfterRedeem: 'After Redeem',
        sidebarPositionAfterAffiliate: 'After Affiliate',
        sidebarPositionAfterProfile: 'After Profile',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Dora2API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Dora2API AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
