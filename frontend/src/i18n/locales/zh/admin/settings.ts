export default {
    settings: {
      ...
      payment: {
        ...
        strategyPriorityFailover: '易支付主备故障切换',
        strategyPriorityFailoverHint: '易支付实例按列表顺序主备切换；仅二维码模式可参与，超时不会自动重试以避免重复收款。',
        failoverPriority: '易支付主备优先级 #{priority}',
        failoverPopupConflict: '{provider} 支持 {method}，但使用了弹窗模式。易支付主备故障切换仅支持二维码模式。',
